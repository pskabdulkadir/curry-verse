...
export default function EnhancedAdminPanel() {
  ...
  const [contentData, setContentData] = useState({
    homepage: {
      ...
      heroDescription:
        "7 seviyeli nefis mertebeleri sistemi ile hem ruhsal hem de finansal gelişim. Binary MLM ağı ile pasif gelir fırsatları.",
      ctaButtonText: "Hemen Katıl",
      ctaSecondaryText: "Kazançları Görüntüle",
      feature1Title: "Binary Network",
                ...
                {selectedContentSection === "about" && (
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Hakkım��zda sayfasının tüm içeriklerini düzenleyin
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
